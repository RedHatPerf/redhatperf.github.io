...
* **Rootless container networking can silently dominate benchmark results.** pasta added 0.9ms per SQL statement -- invisible unless you measure the network path independently.
