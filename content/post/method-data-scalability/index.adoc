...
- **In OpenShift:**  
  Use [Topology Manager](https://docs.openshift.com/container-platform/latest/nodes/topology-manager.html) to ensure your pods run on CPUs within a single NUMA node. This reduces the performance hit caused by spreading CPU resources across multiple nodes.
