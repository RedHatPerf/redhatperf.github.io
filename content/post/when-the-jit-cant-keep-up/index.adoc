...
* **Leyden does not yet cache compiled code.** Until AOT Code Compilation (https://openjdk.org/jeps/8335368[JEP draft 8335368]) ships, Leyden can make the warmup problem worse, if C2 is starved. Virtual threads can recover the lost throughput.
