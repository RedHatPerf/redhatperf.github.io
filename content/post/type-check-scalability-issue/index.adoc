...
<div class="content">
<iframe width="560" height="315" src="https://youtu.be/G40VfIsnCdo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
</div>
++++
...
which modifies the x86 register that is used to track the https://en.wikipedia.org/wiki/Stack_register[Stack Pointer]
